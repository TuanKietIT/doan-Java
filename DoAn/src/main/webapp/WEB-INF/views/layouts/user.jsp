...
<head>
    ...
    <title><decorator:title default="|Trang : home|" /></title>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href=" <c:url value="/assets/user/images/ico/apple-touch-icon-144-precomposed.png" />" rel="stylesheet" >
