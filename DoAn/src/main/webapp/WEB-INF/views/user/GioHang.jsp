					...
					<tbody>
                      	<c:forEach var="item" items="${ Cart }" varStatus="index">
	                        <tr>
								...
								<td >
									<a class="cart_quantity_delete edit-cart" style="font-size:20px;text-aligh:center"  data-id="${ item.key }"><i class="fa-solid fa-pen-to-square"></i></a>
								</td>
								<td >
									<a class="cart_quantity_delete" style="font-size:20px;text-aligh:center" href='<c:url value="/DeleteCart/${ item.key }" />'><i class="fa-solid fa-calendar-xmark"></i></a>
								</td>
							</tr>
                        </c:forEach>        
