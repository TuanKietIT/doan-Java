                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                               <form:form class="cmxform form-horizontal" action="them-san-pham"   method="POST" modelAttribute="sanpham" > 
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Loại sản phẩm</label>
                                        <div class="col-lg-6">
                                           <form:input class=" form-control" type="text" path="id_loai"  /> 
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Tên sản phẩm</label>
                                        <div class="col-lg-6">
                                           <form:input class=" form-control" type="text" path="tensanpham" /> 
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Giá bán</label>
                                        <div class="col-lg-6">
                                             <form:input class=" form-control" type="text" path="giaban" /> 
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                             <form:textarea class=" form-control" type="text" path="mota" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Ngày tạo</label>
                                        <div  class="col-lg-6">
                                            <form:input class=" form-control" type="date" path="ngaytao" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Ngày cập nhật</label>
                                        <div  class="col-lg-6">
                                             <form:input class=" form-control" type="date" path="ngaycapnhat"  rows="8" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" type="submit">Thêm sản phảm</button>
                                            <a style="padding-left:10px;" href='<c:url value="/san-pham-admin" />' class="btn btn-primary" class="active" ui-toggle-class="">Trở lại</a>
