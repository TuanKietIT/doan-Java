...
<section id="container">
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
     <a style="margin-left:-500px;margin-right:300px" href='<c:url value="/them-san-pham" />' class="active" ><i class="fa fa-check text-success text-active"></i>Thêm Khách hàng</a>
